...
public class Triangle2Test {
    ...
    private void checkClassification(int[][] triangles, int expectedResult) {
        for (int[] triangle: triangles) {
            int triangleType = Triangle2.classifyTriangle(triangle[0], triangle[1], triangle[2]);
